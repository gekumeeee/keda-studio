...
export const UI = {
  en: {
    ...
    contact: {
      ...
      sub: "Fill in the form below and we'll get back to you shortly — no chatbots, just the agency.",
      name: 'Name',
      email: 'Email',
      phone: 'Phone number',
  ...
  ar: {
    ...
    contact: {
      ...
      sub: 'املأ الفورم وهنرد عليك في أقرب وقت — مفيش بوتات، الوكالة نفسها.',
      name: 'الاسم',
      email: 'الإيميل',
      phone: 'رقم الموبايل',
