...
// Cairo is the site's own Arabic font (see globals.css); react-pdf walks
// this array per code point and picks the first font that actually has a
// glyph for it, so Latin keeps the branded Bricolage look while Arabic
// runs fall through to Cairo.
//
...
// zero Arabic code points, so the fallback silently finds nothing and the
// broken glyphs come back. The files here are the arabic subset (~72KB each,
// 102 Arabic code points); a ~33KB Cairo file is the latin-only one.
